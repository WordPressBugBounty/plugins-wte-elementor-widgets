...
foreach ( array( 'showFeaturedRibbon', 'showDescription', 'showFeaturedImage', 'showTitle', 'showPrice', 'showStrikedPrice', 'showPricingTypeLabel', 'showDuration', 'showLocation', 'showReviews', 'showWishlist', 'showDiscount', 'showActivities', 'showTripType', 'showGroupSize', 'showTripAvailableTime', 'showViewMoreButton', 'showViewAll', 'showTag' ) as $subkey ) {
...
if ( $results && is_array( $results ) ) :
	...
	foreach ( $attributes->{'filters'}['tripsToDisplay'] as $trip_id ) :
		...
		$args      = array( $arguments, $trip, $results, $pax_label );
