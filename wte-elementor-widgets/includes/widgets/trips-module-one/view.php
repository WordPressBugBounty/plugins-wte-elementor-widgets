...
<div class="wpte-card <?php echo esc_attr( $add_card_class ); ?>" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
	<div class="wpte-card__wrap <?php echo esc_attr( $add_wrap_class ); ?>">
		<div class="wpte-card__media">
			...
			<?php
			if ( ( ( 1 === $index || 2 === $index ) && '1' === $layout_data ) && wte_array_get( $settings, 'showWishlist_hero', false ) ) :
			...
			if ( $showPrice && ( 1 === $index || 2 === $index ) && ! empty( $display_price ) && $display_price > 0 ) :
				...
				<span class="wpte-card__price wpte-card__price--layout-1">
					...
					if ( $showPrice ) :
						...
						<?php if ( 'yes' === wte_array_get( $settings, 'showPricingTypeLabel_hero', false ) && $pricing_type_label ) : ?>
