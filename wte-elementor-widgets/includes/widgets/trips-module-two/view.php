...
$final_meta_data    = wte_array_get( $settings, 'showTripMeta', array( 'showDuration', 'showDifficulty', 'showActivities' ) );
...
<div class="wpte-card <?php echo esc_attr( $add_card_class ); ?>" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
	<div class="wpte-card__wrap <?php echo esc_attr( $add_wrap_class ); ?>">
		<div class="wpte-card__media">
			<?php
			if ( $index === 1 || ( 2 === $index && '2' === $layout_data ) ) :
			...
			<?php
			if ( ( ( 1 === $index || ( 2 === $index && '2' === $layout_data ) ) || '3' === $layout_data ) && wte_array_get( $settings, 'showWishlist', false ) ) :
